    ...
    class ClickManager extends EventManager {
        ...
        constructor(target, includeHover, rightMouseButton, doubleClick) {
            ...
            this.startEvent = (includeHover = this._includeHover, rightMouseButton = this._rightMouseButton, doubleClick = this._doubleClick) => {
                console.log("startEvent =========", rightMouseButton)
                if (this.isEnabled) {
                    return;
                }
                ...
                if (!this._rightMouseButton) {
                    console.log(target.insetContainer.interactive, target.insetContainer.width, target.insetContainer.height)
    ...
    class Widget extends pixi_js.utils.EventEmitter {
        ...
        onLayout(l, t = l, r = l, b = t, dirty = true) {
            ...
            if (this.background) {
                ...
                console.log("onLayout bg size", this.background.width, this.background.height)
            }
        ...
        setBackground(bg) {
            ...
            this.background = bg;
            console.log("set bg", bg.width, bg.height)
            console.log(this.backgorund)
            if (bg) {
                bg.width = this.width;
                bg.height = this.height;
            console.log("set bg size", bg.width, bg.height)
...
Object.assign(window.PUXI, puxi_js)
